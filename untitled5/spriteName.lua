...
local sheetData =
{
	...
	{ name = "jump", frames = { 25, 26, 27, 28 }, time = 500, loopcount = 1 },
	{ name = "rockB", frames = { 5, 11, 17 }, time = 500, loopcount = 1 },
	{ name = "rock", frames = { 16 }, time = 500, loopcount = 0 },
}

local sheet1 = graphics.newImageSheet("/image/player_01.png", sheet1Data )
...
timeAttack = function ( e )
	time = time - e.time
	if time == 0 then isClear0 = false end
end
...
stage0 = function ( )
	...
	--end Point
	endArea = display.newRect(_W*0.95,_H*0.91,64,2)
	physics.addBody( endArea, "static", {} )

	--character Image
	char = display.newSprite( sheet1, sheetData )
	--0.1 / 0.7
